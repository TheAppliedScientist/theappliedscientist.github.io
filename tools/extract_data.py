...
dump("judge_comparison.json", {
    ...
    "groups": [
        ...
        {"group": "LLM", "rows": [
            ...
            row("DeepSeek V4 Pro",   [(78.6, 7.5), (96.5, 3.0), (79.2, 5.1), (80.4, 3.2)]),
        ]},
        {"group": "LLM with search", "rows": [
            ...
            row("DeepSeek V4 Pro",   [(72.9, 17.6), (93.1, 6.5), (73.8, 8.1), (79.7, 6.4)]),
        ]},
        {"group": "Multi-agent with search", "rows": [
            row("Agent Review (Gemini 3.1 Pro)",    [(52.1, 18.9), (89.5, 10.4), (60.7, 10.8), (65.6, 7.9)]),
            row("Agent Review (DeepSeek V4 Flash)", [(61.7, 20.5), (92.3, 4.0), (72.8, 11.6), (68.5, 8.7)]),
            row("AI Scientist v2 (Gemini 3.1 Pro)", [(50.2, 22.3), (84.5, 12.1), (58.5, 12.5), (62.2, 9.5)]),
            row("AI Scientist v2 (DeepSeek V4 Flash)", [(56.7, 24.1), (91.2, 7.2), (88.3, 8.6), (67.1, 10.3)]),
            row("DeepReviewer-v2 (StepFun 3.5 Flash)", [(63.4, 16.8), (94.6, 2.5), (91.8, 5.4), (77.3, 11.6)]),
