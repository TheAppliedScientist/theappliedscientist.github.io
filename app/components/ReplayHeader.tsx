  ...
  return (
    <header className="replay-shared-header">
      ...
      <div className="replay-view-switch" role="group" aria-label="Replay view">
        ...
        <button type="button" className={view === "rounds" ? "is-active" : ""} aria-pressed={view === "rounds"} onClick={() => onChange("rounds")}>Trajectory Overview</button>
        <button type="button" className={view === "execution" ? "is-active" : ""} aria-pressed={view === "execution"} onClick={() => onChange("execution")}>Full Trajectory</button>
      </div>
