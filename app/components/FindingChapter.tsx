    ...
    <section className="research-chapter finding-chapter" id="finding">
      ...
      <div className="chapter-body">
        <header className="chapter-head finding-head">
          ...
          <p className="finding-head-result">AppliedScientist resolves <strong>128 of 150</strong> execution weaknesses, but only <strong>2 of 18</strong> idea weaknesses.</p>
        </header>

        <div className="finding-plate">
          <figure>
            <WeaknessBars categories={ladder.categories} />
            <figcaption>Resolution rate of AI-suggested weaknesses by AppliedScientist. Intervals show Wilson 95% confidence intervals.</figcaption>
          </figure>
          <aside className="finding-reading">
            <p className="finding-reading-label">What the contrast shows</p>
            ...
            <p className="finding-reading-note">Revision consistently succeeds on suggestions that require stronger evidence via experiments, baselines, ablations, or clearer presentation, but rarely changes judgements about novelty or significance.</p>

            <EvidenceDrawer title="Rejection reasons and novelty verification" trigger="Examine the supporting analysis" tabs={[
